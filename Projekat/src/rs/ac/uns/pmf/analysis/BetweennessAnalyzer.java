...
public class BetweennessAnalyzer extends Analyzer {
	...
	public BetweennessAnalyzer(Graph<Vertex, Edge> graph, Decomposer decomposer) {
		super(graph);
	...
	@Override
	public void analyze() {
		rows.add("Id;Shell index;Betweenness centrality");
