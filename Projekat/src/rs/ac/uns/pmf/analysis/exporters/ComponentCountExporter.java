...
public class ComponentCountExporter extends Exporter {

	private Decomposer decomposer;

	public ComponentCountExporter(Graph<Vertex, Edge> graph, Decomposer decomposer) {
		super(graph);
	...
	public void saveToCSV(String folder, String file) {
		try (BufferedWriter bw = new BufferedWriter(new PrintWriter(new FileWriter("src/" + folder + "/" + file)))) {
			bw.append("Core;Component count\n");
