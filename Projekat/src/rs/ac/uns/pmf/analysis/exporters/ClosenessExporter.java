...
public class ClosenessExporter extends Exporter {
	...
	public ClosenessExporter(Graph<Vertex, Edge> graph, Map<Vertex, Integer> shellIndices) {
		super(graph);
	...
	public void saveToCSV(String folder, String file) {
		try (BufferedWriter bw = new BufferedWriter(new PrintWriter(new FileWriter("src/" + folder + "/" + file)))) {
			bw.append("Id;Shell index;Closeness centrality\n");
