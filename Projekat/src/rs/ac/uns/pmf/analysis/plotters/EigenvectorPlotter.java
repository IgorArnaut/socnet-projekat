...
public class EigenvectorPlotter<V, E> extends Plotter<V, E> {
	...
	public EigenvectorPlotter(Graph<V, E> graph, Map<V, Integer> shellIndices) {
		super(graph);
	...
	protected XYDataset createDataset() {
		...
		XYSeries series = new XYSeries("Eigenvector centralities");
	...
	public void plot() {
		...
		JFreeChart chart = ChartFactory.createScatterPlot("Shell indices vs. Eigenvector centralities", "Shell indices",
				"Eigenvector centralities", dataset);
		plot(chart);
	}
